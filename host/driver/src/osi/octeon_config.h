...
#define	  CN23XX_PKI_MAX_FRAME_SIZE  65535
#define   CN23XX_RAW_FRONT_SIZE    48
/* this is the max jabber value.Any packets greater than this size sent over
 * DPI will be truncated.
 */
#define   CN23XX_MAX_INPUT_JABBER  (CN23XX_PKI_MAX_FRAME_SIZE \
		- CN23XX_RAW_FRONT_SIZE)
/* this is the optimal size to use HW TSO
 * Pcakets greater than this  will use SW TSO
 */
#define   CN23XX_DEFAULT_INPUT_JABBER  60000
...
#define   OCTEON_OQ_INFOPTR_MODE       0
...
#define CFG_SET_NUM_DEF_TX_DESCS(cfg, val)       ((cfg)->num_def_tx_descs = val)
#define CFG_SET_NUM_DEF_RX_DESCS(cfg, val)       ((cfg)->num_def_rx_descs = val)
 ...
 * 1 zombie lists - timeouted sc list. A sc in the list is the sc does not 
 *                  get its response within LIO_SC_MAX_TMO_MS milli second.
 * 1 process done list - to-be-freed sc list
 */
