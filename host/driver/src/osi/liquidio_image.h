...
#define LIO_FW_NAME_TYPE_OVS    "vsw"
#define LIO_FW_NAME_TYPE_IPSEC  "ipsec"  /*LINUX_IPSEC firmware image*/
#define LIO_FW_NAME_TYPE_OVSIPSEC  "ovsipsec"  /*OVSIPSEC firmware image*/
