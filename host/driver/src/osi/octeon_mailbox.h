...
#define OCTEON_CORES_CRASHED		0x3
#define OCTEON_PF_CHANGED_VF_MACADDR    0x4
#define OCTEON_PF_SET_OR_CLEARED_VF_VLAN 0x5
#define OCTEON_VF_LINFO			0x6
#define OCTEON_IS_VF_ACTIVE		0x7
...
#define LIO_MBOX_WRITE_WAIT_TIME            1
