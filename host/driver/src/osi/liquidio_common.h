...
#define LIQUIDIO_BASE_MICRO_VERSION 3
...
#define OPCODE_IPSEC 3           /* used for LINUX_IPSEC operations */
#define OPCODE_LAST OPCODE_IPSEC
...
#define OPCODE_NIC_DCB_CFG	       0x0C
#define OPCODE_NIC_DCB_INFO	       0x0D	
#define OPCODE_NIC_DCBX_TIMER	       0x0E
#define OPCODE_NIC_QCN_BYTE_COUNTER    0x0F
#define OPCODE_NIC_QCN_TIMER_COUNTER   0x10
...
#define OPCODE_NIC_GET_DUMP            (0x18)
#define OPCODE_NIC_SET_DUMP            (0x19)
#define OPCODE_NIC_GET_DUMP_FLAG       (0x20)
...
#define OPCODE_NIC_SFP_MOD_INFO		0x21
#define OPCODE_NIC_VF_PORT_STATS	0x22

#define OPCODE_NIC_LAST_CMD		OPCODE_NIC_VF_PORT_STATS
...
#define LIQUIDIO_MGMT_INTF_CAP LIQUIDIO_TIME_SYNC_CAP
...
#define	  OCTNET_CMD_PKT_STEERING_CTL   0x1e

#define   OCTNET_CMD_QUEUE_COUNT_CTL	0x1f

#define	  OCTNET_CMD_SET_FNV		0x1d
...
#define   OCTNET_CMD_FNV_ENABLE        0x1
#define   OCTNET_CMD_FNV_DISABLE       0x0
#define   OCTNET_CMD_PKT_STEERING_ENABLE        0x0
#define   OCTNET_CMD_PKT_STEERING_DISABLE       0x1
#define   OCTNET_CMD_VLAN_FILTER_ENABLE 	0x1
#define   OCTNET_CMD_VLAN_FILTER_DISABLE 	0x0

#define   OCTNET_CMD_FAIL 0x1

#define   LIO_CMD_WAIT_TM 400
...
union octeon_rh {
	...
	struct {
		...
		u64 subcode:8;
		u64 len:3;     /** additional 64-bit words */
#if   defined(CAVIUM_ONLY_BPF_OFFLOAD_SUPPORT) || defined(LINUX_IPSEC)
		u64 extra:27;  /* Only one macro is defined */
#else
		u64 extra:28;
#endif
		u64 vlan:12;
...
// response to 'OPCODE_NIC_UBOOT_CTL' subcmds
